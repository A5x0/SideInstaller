...
#ifndef SIDEINSTALLER_SWIFT_H
#define SIDEINSTALLER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SideInstaller",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13SideInstaller9KeepAlive")
...
@class CLLocation;
@interface KeepAlive (SWIFT_EXTENSION(SideInstaller)) <CLLocationManagerDelegate>
